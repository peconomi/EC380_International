...
Debt burdens worsen the budget position of central governments by adding payments that must be made to outsiders, and they .hi-pink[reduce the availability of public funds] for important domestic needs such as infrastructure, schools, and health care. 
...
One notable movement is the .hi-pink[Highly Indebted Poor Country (HIPC) program]. 

--

Joint venture of the World Bank, the IMF, and high-income-country governments

--

Provide debt forgiveness for a select group of countries that must qualify based on .hi-pink[high levels of poverty and debt] and a .hi-pink[track record of economic reform].

...
subtitle: "Global Finance: Exchange Rates Med-SR"
...
$$\underbrace{\frac{F_{\text{USD}/\text{EUR}}}{R_{\text{USD}/\text{EUR}}}-1}_{\text{Forward Premium}} = \underbrace{\frac{E(F)_{\text{USD}/\text{EUR}}}{F_{\text{USD}/\text{EUR}}}-1}_{\text{Expected Rate of Depreciation}}$$
